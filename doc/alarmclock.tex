...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Submit by 19:00 on Wednesday 8th October 2025}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\begin{minted}{shell}
prompt> git clone https://gitlab.doc.ic.ac.uk/lab2526_autumn/pintos_task0_<login>.git
\end{minted}
%
...
%
\begin{minted}{shell}
  prompt> git clone git@gitlab.doc.ic.ac.uk:lab2526_autumn/pintos_task0_<login>.git
\end{minted}
%
...
The documentation for all future Tasks is self-contained in the PintOS manual.


\subsection*{Working on PintOS}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
First, make sure that you have set up Git correctly on your machine.
At a minimum, you should configure your \textbf{name} and \textbf{email address} to sensible values (not machine defaults). If you don't remember how to do this from last year, then I recommend reading the \href{https://swcarpentry.github.io/git-novice/02-setup.html}{Software Carpetry 'Setting Up Git' guide}.

You should then work on the files in your local workspace, making regular commits and pushes back to your \shell{GitLab} Git repository.
...
%
\begin{minted}{shell}
  prompt> git commit -m "feat: your *meaningful* commit message here"
\end{minted}
%
...
\href{https://scientia.doc.ic.ac.uk/api/resources/12739/file/DoCSoc\%20-\%20Basics\%20of\%20Git\%20and\%20GitLab.pdf}{Introduction to Programming Utilities}
and
\href{https://scientia.doc.ic.ac.uk/api/resources/15719/file/DoCSoC\%20-\%20Git\%20for\%20Group\%20Projects.pdf}{Git for Group Projects}.\\
...
\paragraph{Part 8:}
Explain the property of {\bf reproducibility} in the context of testing code and how the lack of reproducibility will affect debugging.
...
Passing the Automated Tests ({\bf 5 marks}).

Performance in the Code Review ({\bf 15 marks}).
...
A6: ({\bf 2 marks}) \\
Why did you choose to design your solution to this task in the way that you did? \\
...
and prompt you to upload a design document file under the usual ``original work'' disclaimer.
...
You should submit your Task 0 design document (\shell{designT0.pdf}) and the chosen version of your code to Scientia by 19:00 on Wednesday 8th October 2025.\\
...
\begin{tabular}{l@{\qquad\qquad}l}
  ...
  Part B: Automated Tests     & {\bf 5 marks} \\
  Part B: Code Review         & {\bf 15 marks} \\
...
\noindent \textbf{We aim for feedback on this exercise to be returned by Wednesday 22nd October 2025.}
